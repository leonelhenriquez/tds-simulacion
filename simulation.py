...
What changed:
  ...
  - Close perpendicular conflicts at intersections sometimes become crashes;
    otherwise vehicles keep using the existing avoidance behavior
  - Manual unofficial routes can be placed over roads or blocks and are used
    before generated bypasses when they fit the blocked street
